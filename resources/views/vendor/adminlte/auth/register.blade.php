    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="id" class="form-control {{ $errors->has('id') ? 'is-invalid' : '' }}"
                   value="{{ old('id') }}" placeholder="Biedra numurs" autofocus>
        ...
        <div class="input-group mb-3">
            <input type="text" name="phone" class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}"
                   value="{{ old('phone') }}" placeholder="Telefona nr." autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
        ...
        <div class="input-group mb-3">
            <select name="status_id" class="form-control">
                <option value="1">Zēns</option>
                <option value="2">Komiltonis</option>
                <option value="3">Filistrs</option>
            </select>
        </div>
